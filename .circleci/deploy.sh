...
curl -v -X POST -H "Authorization: token $GITHUB_TOKEN" --data-binary @"/home/circleci/solrconfig.zip" -H "Content-Type: application/octet-stream" "https://uploads.github.com/repos/tulibraries/funcake-oai-solr/releases/$RELEASE_ID/assets?name=funcake-oai-$CIRCLE_TAG.zip"
